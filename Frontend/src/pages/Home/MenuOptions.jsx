...
function MenuSlider() {
    return (
        <>
            <div
                className="no-scrollbar flex w-full snap-x items-center justify-start gap-2 overflow-x-scroll p-2 shadow-inner"
                title="View Category"
            >
...
function SliderCard({ cardImage, cardImageName }) {
    return (
        <>
            <div className="flex h-[11rem] flex-shrink-0 transform snap-start flex-col items-center justify-between rounded-xl bg-[#181818] p-2 text-white shadow-lg transition-all duration-300 lg:h-[17rem] lg:bg-white lg:text-black">
                <span className="">
                    <img
                        src={cardImage}
                        alt=""
